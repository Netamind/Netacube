...
<tr id="<?php echo e($row); ?>">
   <td ><?php echo e($d->name); ?></td>
	 <td style="text-align:center"><?php echo e($d->dob); ?></td>
   <td style="text-align:center"><?php echo e($d->phone); ?></td>
   <td style="text-align:center"><?php echo e($d->email); ?></td>
   <td style="text-align:center"><?php echo e($d->idtype); ?></td>
   <td style="text-align:center"><?php echo e($d->idnumber); ?></td>
   <td style="text-align:center"><?php echo e($d->started_on); ?></td>
   <td style="text-align:center"><?php echo e($d->registered_on); ?></td>
	 <td style="text-align:center">
		<a href="#" class="editDataBtnClass" 
    editId ="<?php echo e($d->id); ?>"
    editRow=<?php echo e($row); ?> 
    editname="<?php echo e($d->name); ?>" 
    editdob="<?php echo e($d->dob); ?>" 
    editphone="<?php echo e($d->phone); ?>"
    editemail="<?php echo e($d->email); ?>"
    editidtype="<?php echo e($d->idtype); ?>" 
    editidnumber="<?php echo e($d->idnumber); ?>"
    editstartedon="<?php echo e($d->started_on); ?>"
    > 
    <i class="fa fa-edit text-primary fa-2x" ></i>
    </a>
		<a href="#" class="deleteDataBtnClass" deleteLabel="<?php echo e($d->name); ?>"  deleteId="<?php echo e($d->id); ?>" deleteRow="<?php echo e($row); ?>">
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Netamind Technology\Desktop\Netacube\resources\views/admin/employees.blade.php ENDPATH**/ ?>