...
<div class="loading-status" id="loading-status" style="display:none">
  <div class="waves"></div>
    ...
    $product = DB::table('retailbaseproducts')->where('id', $productId)->first();
...
<a href="#" class="btn border-secondary" style="margin-top:5px">
...
<div class="card-body">
<a href="#" class="btn" id="editDataBtnId" style="margin-left:-17px"
editid = "{{$product->id}}"
...
{{$product->product}} [ @convert($product->sellingprice) / {{$product->unit}} ]
</a>
