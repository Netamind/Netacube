...
<option value="" hidden>Category : <?php echo e($categoryName); ?></option>
<?php
...
<select name="supplier" id="" style=";border:none;margin-left:-4px" onchange="submitSupplierId(this.value)">
    <option value="" hidden>Supplier : <?php echo e($supplierName); ?></option>
    <?php
    ...
    <option value="<?php echo e($sup->id); ?>"><?php echo e($sup->supplier); ?></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $row = "row".$d->id;?>
<tr id="<?php echo e($row); ?>">
   <td ><input type="checkbox" name="select" class="select"> <?php echo e($d->product); ?></td>
   <td style="text-align:center"><?php echo e($d->unit); ?></td>
   <td style="text-align:center"> <?php 
                $value = is_numeric($d->orderprice) ? $d->orderprice : 0; 
   ...
   <td style="text-align:center"> <?php 
                ...
                echo number_format($value, 0); 
            ?> </td>
   <td style="text-align:center"><?php echo e($d->batchnumber); ?></td>
   <td style="text-align:center"><?php echo e($d->expirydate); ?></td>
   <td style="text-align:center"><?php echo e($d->vat); ?></td>
	 <td style="text-align:center">
		<a href="#" class="editDataBtnClass" 
    editId ="<?php echo e($d->id); ?>"
    editRow=<?php echo e($row); ?> 
    editproduct="<?php echo e($d->product); ?>" 
    editsupplier="<?php echo e($d->supplier); ?>" 
    editunit="<?php echo e($d->unit); ?>" 
    editorderprice="<?php echo e($d->orderprice); ?>" 
    editsellingprice="<?php echo e($d->sellingprice); ?>" 
    editbatchnumber="<?php echo e($d->batchnumber); ?>" 
    editexpirydate="<?php echo e($d->expirydate); ?>" 
    editvat="<?php echo e($d->vat); ?>" 
    > 
    <i class="fa fa-edit text-primary fa-2x" ></i>
    </a>
		<a href="#" class="deleteDataBtnClass" deleteLabel="<?php echo e($d->product); ?>"  deleteId="<?php echo e($d->id); ?>" deleteRow="<?php echo e($row); ?>">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title">New product <strong><?php echo e($categoryName); ?></strong></h5>
      ...
      <div class="form-group col-md-6">
        ...
        <option value="<?php echo e($vat->code); ?>"><?php echo e($vat->status); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
			</div>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\PROJECTS\LARAVEL\Netacube\resources\views/wholesale/adminbaseproducts.blade.php ENDPATH**/ ?>