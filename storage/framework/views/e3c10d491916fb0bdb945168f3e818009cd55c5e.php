...
<h4> <i class="feather icon-flag"></i> Value Added Tax (VAT)
...
<li class="nav-item">
<a class="nav-link active" data-toggle="tab" href="#home7" role="tab"><i class="feather icon-folder"></i> Statuses</a>
<div class="slide"></div>
</li>
<li class="nav-item">
<a class="nav-link" data-toggle="tab" href="#profile7" role="tab"><i class="feather icon-lock"></i> Configuration</a>
<div class="slide"></div>
</li>
</ul>
...
<tr id="<?php echo e($row); ?>">
   ...
   <td style="text-align:left"><?php echo e($d->description); ?></td>
...
<?php echo e($disabled_text); ?>

<?php else: ?>
<?php echo e($enabled_text); ?>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Netamind Technology\Desktop\Netacube\resources\views/admin/vatstatuses.blade.php ENDPATH**/ ?>