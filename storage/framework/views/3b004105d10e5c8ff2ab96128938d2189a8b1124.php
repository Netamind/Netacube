...
<h4><i class="feather icon-book"></i>Categories
...
<tr id="<?php echo e($row); ?>">
 ...
 <?php endif; ?> 
    ...
    editdescription="<?php echo e($d->description); ?>" 
    > 
    <i class="fa fa-edit text-primary fa-2x" ></i>
    </a>
		<a href="#" class="deleteDataBtnClass" deleteLabel="<?php echo e($d->category); ?>"  deleteId="<?php echo e($d->id); ?>" deleteRow="<?php echo e($row); ?>">
...
<div class="modal fade-scale" tabindex="-1" role="dialog" id="newDataModal" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="insert-business-category" method="post"  enctype="multipart/form-data" id="newDataForm">
			<?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\PROJECTS\LARAVEL\Netacube\resources\views/admin/businesscategories.blade.php ENDPATH**/ ?>