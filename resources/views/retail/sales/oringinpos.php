@extends('retail.retaildashboard')
@section('content')
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Retail Dashboard - Mobile point of sale</title>
  <style>
...
<a href="retail-pos-mobile" title="{{$datestate}}" style="font-size:16px;font-weight:bold;color:#666666"><i class="fa fa-tablet" style="margin-top:7px"></i>  {{$disaplaydate}}</a>




<!--<a href="#" style="float:right;font-size:19px;font-weight:bold;" id="actions"><i class="fa fa-list"></i></a>-->
...
<?php
$products = DB::table('retailproducts')->where('branch',Auth::user()->branch)->get()
?>
@foreach($products as  $product)
<tr class="trow">
<?php
  $productname = DB::table('baseproducts')->where('id',$product->productid)->value('product');
  $unit = DB::table('baseproducts')->where('id',$product->productid)->value('retailunit');
  $price1 = DB::table('baseproducts')->where('id',$product->productid)->value('retailprice');
  ...
  <div class="modal fade card-info" id="sales-modal">
        <div class="modal-dialog  ">
          <div class="modal-content">
            <?php
            $branchName = DB::table('branches')->where('id',Auth::user()->branch)->value('branch');
            ?>
