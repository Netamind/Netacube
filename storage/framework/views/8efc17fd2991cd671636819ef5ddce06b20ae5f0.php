...
<span>
<i class="feather icon-user" style="font-size:20px"></i>  <?php echo e(Auth::user()->username); ?>
...
<li class="pcoded-hasmenu    
  <?php echo e(request()->is('admin-dashboard') ? 'active pcoded-trigger' : ''); ?> 
  <?php echo e(request()->is('app-data') ? 'active pcoded-trigger' : ''); ?> 
  <?php echo e(request()->is('categories') ? 'active pcoded-trigger' : ''); ?> 
  <?php echo e(request()->is('users') ? 'active pcoded-trigger' : ''); ?> 
  <?php echo e(request()->is('employees') ? 'active pcoded-trigger' : ''); ?> 
  <?php echo e(request()->is('users-roles') ? 'active pcoded-trigger' : ''); ?>

  <?php echo e(request()->is('branches') ? 'active pcoded-trigger' : ''); ?>

  <?php echo e(request()->is('business-sector') ? 'active pcoded-trigger' : ''); ?>

  <?php echo e(request()->is('vat-statuses') ? 'active pcoded-trigger' : ''); ?>

  <?php echo e(request()->is('business-categories') ? 'active pcoded-trigger' : ''); ?>

  <?php echo e(request()->is('suppliers') ? 'active pcoded-trigger' : ''); ?>
...
<li class="  <?php echo e(request()->is('app-data') ? 'active' : ''); ?>  ">
<a href="app-data">
...
<li class="<?php echo e(request()->is('business-sector') ? 'active' : ''); ?> ">
...
<li class="<?php echo e(request()->is('business-categories') ? 'active' : ''); ?> ">
...
<li class="<?php echo e(request()->is('branches') ? 'active' : ''); ?>">
<a href="branches">
...
<li class="<?php echo e(request()->is('users-roles') ? 'active' : ''); ?>">
<a href="users-roles">
...
<li class="<?php echo e(request()->is('vat-statuses') ? 'active' : ''); ?>">
<a href="vat-statuses">
...
<li class="pcoded-hasmenu
  <?php echo e(request()->is('admin-wholesale-baseproducts') ? 'active pcoded-trigger' : ''); ?> 
...
<li class="<?php echo e(request()->is('admin-wholesale-baseproducts') ? 'active' : ''); ?>">
...
<li class="<?php echo e(request()->is('website-settings') ? 'active' : ''); ?> ">
...
<?php echo $__env->yieldContent('content',View::make('admin.default')); ?>
...
</html><?php /**PATH C:\Users\dell\Desktop\PROJECTS\LARAVEL\Netacube\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>