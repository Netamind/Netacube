...
class AdminWholesaleController extends Controller
{
    public function adminwholesalebaseproducts(){
        return view('admin.wholesale.adminwholesalebaseproducts');
    }

    public function adminwholesalebranchproducts(){
        return view('admin.wholesale.adminwholesalebranchproducts');
    }


  public function  adminwholesaleproductlogs(){
    return view('admin.wholesale.adminwholesaleproductlogs');
}


public function adminwholesaleproductlogsdatewise(){

  return view('admin.wholesale.adminwholesaleproductlogsdatewise');
}

public function  adminwholesalesupplies(){
  return view('admin.wholesale.adminwholesalesupplies');
}


public function  adminwholesaleclients(){
  return view('admin.wholesale.adminwholesaleclients');
}
