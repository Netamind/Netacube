...
<tr id="<?php echo e($row); ?>">
   ...
   <td style="text-align:center"><?php echo e($d->email); ?></td>
    ...
    editbranch="<?php echo e($d->branch); ?>" 
    ...
    <i class="fa fa-edit text-primary fa-2x" ></i>
		...
		<a href="#" class="deleteDataBtnClass" deleteLabel="<?php echo e($d->branch); ?>"  deleteId="<?php echo e($d->id); ?>" deleteRow="<?php echo e($row); ?>">
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\PROJECTS\LARAVEL\Netacube\resources\views/admin/branches.blade.php ENDPATH**/ ?>