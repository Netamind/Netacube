...
<?php
    ...
    $date = Carbon::today()->toDateString();
     ...
     function getTransid($n) {
      ...
      $branch = DB::table('userbranch')->where('employeeid',Auth::user()->employeeid)->value('branchid');
      $user = Auth::user()->id;
     $datestring = $date;
...
<!--Links---->    
<div class="col-md-12">
<button class="btn" onclick="uploadData()" id="uploaddatabtn" style="font-size:16px;font-weight:bold;color:#666666">
  <i class="fa fa-cloud-upload"></i>
 <span style="font-weight:bold;color:#f2f2f2;" id="cloudItems"></span>
 </button>
...
<a href="#" class="btn " id="calculatorbtn" style="float:right;color:#666666;font-weight:bold" >       
...
<td class="tcell" style="width:60%;word-break:break-word;overflow-wrap:break-word;display:inline-block;white-space:normal;">
  ...
  <span style="color:gray;font-family:monospace"> @convert($price)/{{$unit}} @convert2($product->quantity)</span>
</td>
<td style="text-align:center;white-space:nowrap;padding-top:10px;padding-bottom:0px;width:40%;border:none">
  ...
  <div class="input-group" style="font-size:10px">
    <input type="inputbox" id="{{$inputid}}" class="form-control cart-input submit-data-input" style="text-align:center;border: 1px solid  #999999" name="quantity"  autocomplete="off" min="0" value="1">
    <div class="input-group-append" style="font-size:10px">
     <a href="#"  type="text"   style="text-align:center;border: 1px solid  #999999;" class="input-group-text sale-data text-primary submit-data-input btn "
      id1="{{$productid}}" 
      id2="{{$productname}}"                    
      id3 = "{{$unit}}"    
      id4="{{$price}}"               
      ...
      id11 = "{{$inputid}}"                                    
      >
      <i class="fa fa-angle-right tex-info" style="font-size:20px"></i>
    </a>
  </div>
</div>
</div>
...
<i class="fa fa-shopping-cart"></i> <span  id="cartTotal1" style="color:#f2f2f2;font-weight:bold;font-size:17px"></span>
...
<a href="#" id="submitcartbtn" onclick="clearCartData()" style="float:right;margin-left:5px;border:2px solid silver;font-weight:bold;color:silver;width:80px" class="btn">
 <i class="fa fa-angle-right" style="color:#f2f2f2"></i>
</a>
</div>
</div>
<!--/Cart total -->
...
<!--Change --->
<div class="container" style="padding-top:10px;padding-bottom:20px;margin-bottom:30px;margin-top:3px">
