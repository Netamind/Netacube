...
<h4><i class="feather icon-lock" style="font-weight:bold;color:gray;"></i> Roles
<a href="#" class="btn btn-primary" id="newDataBtn" style="float:right"><i class="fa fa-plus-circle" style="color:white"></i>New Role</a>
</h4>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Netamind Technology\Desktop\Netacube\resources\views/admin/userroles.blade.php ENDPATH**/ ?>