...
.js-example-basic-single .select2-selection__rendered {
...
<table id="users-table" class="table-striped-column  table-sm table-striped table-fixed-first-column table-fixed-header" >
...
<tr id="<?php echo e($row); ?>">
   <td ><?php echo e($d->username); ?></td>
	 ...
	 <td style="text-align:center"><?php echo e($d->role); ?></td>
    ...
    editemployee="<?php echo e($d->employeeid); ?>" 
    editrole="<?php echo e($d->role); ?>" 
    editbranch="<?php echo e($branchid); ?>" 
    > 
    <i class="fa fa-edit text-primary fa-2x" ></i>
    </a>
		<a href="#" class="deleteDataBtnClass" deleteLabel="<?php echo e($d->username); ?>"  deleteId="<?php echo e($d->id); ?>" deleteRow="<?php echo e($row); ?>">
...
<div class="modal fade-scale" tabindex="-1" role="dialog" id="newDataModal" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="insert-user" method="post"  enctype="multipart/form-data" id="newDataForm">
			<?php echo csrf_field(); ?>
...
<div class="modal fade-scale" tabindex="-1" role="dialog" id="editDataModal" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="form-group">
				<label for="#">Employee</label>
		     <select name="employeeid"  class="form-control" id="editemployee" readonly>
          <option value="" hidden>Select Employee</option>
          <?php $employees=DB::table('employees')->where('status',1)->get();?>
          <?php $__currentLoopData = $employees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <option value="<?php echo e($employee->id); ?>"><?php echo e($employee->name); ?></option>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\PROJECTS\LARAVEL\Netacube\resources\views/admin/users.blade.php ENDPATH**/ ?>