...
<h4><i class="feather icon-grid" style="font-weight:bold;color:gray"></i> Sectors
...
<table id="levels-table" class="table-striped-column table table-sm table-striped table-fixed-first-column table-fixed-header" >
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\Netacube\resources\views/admin/businesssectors.blade.php ENDPATH**/ ?>