...
<select name="category" id="" style="background:trasparent;margin-left:-12px;border:none" onchange="submitBranchId(this.value)">
...
<a href="admin-retail-openingstock" title="" style="font-size:16px;font-weight:bold;color:#666666;margin-left:10px">
  {{$disaplaydate}}
</a>
