...
<h4><i class="feather icon-chevrons-up"></i> Suppliers
...
<tr id="<?php echo e($row); ?>">
   <td ><?php echo e($d->supplier); ?></td>
   <td style="text-align:center"><?php echo e($d->sector); ?></td>
   ...
   <td style="text-align:center"><?php echo e($d->address); ?></td>
   <td style="text-align:center"><?php echo e($d->contact); ?></td>
   <td style="text-align:center"><?php echo e($d->email); ?></td>
	 <td style="text-align:center">
		<a href="#" class="editDataBtnClass" 
    editId ="<?php echo e($d->id); ?>"
    editRow=<?php echo e($row); ?> 
    editsupplier="<?php echo e($d->supplier); ?>" 
    editsector="<?php echo e($d->sector); ?>" 
    editcategory="<?php echo e($d->category); ?>" 
    editaddress="<?php echo e($d->address); ?>" 
    editcontact="<?php echo e($d->contact); ?>" 
    editemail="<?php echo e($d->email); ?>" 
    > 
    <i class="fa fa-edit text-primary fa-2x" ></i>
    </a>
		<a href="#" class="deleteDataBtnClass" deleteLabel="<?php echo e($d->supplier); ?>"  deleteId="<?php echo e($d->id); ?>" deleteRow="<?php echo e($row); ?>">
				...
				<input type="text"name="supplier" class="form-control" placeholder="Enter supplier name">
                    ...
                    <div class="form-group">
                     ...
                     <select name="sector" id="" class="form-control">
                        ...
                        <option value="<?php echo e($sec->sector); ?>"><?php echo e($sec->sector); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                            </div>
                        ...
                        ?>
                        <?php $__currentLoopData = $sectors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dell\Desktop\PROJECTS\LARAVEL\Netacube\resources\views/admin/suppliers.blade.php ENDPATH**/ ?>